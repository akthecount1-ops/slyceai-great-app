        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div style={{
            ...
            margin: '0 auto 20px', boxShadow: '0 8px 24px rgba(0,0,0,0.08)'
             ...
             <UserPlus size={32} strokeWidth={1.5} style={{ color: 'var(--accent)' }} />
          </div>
          <h1 style={{
        ...
        <div style={{
          ...
          <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <label htmlFor="name" style={{ fontSize: '13.5px', fontWeight: 500, color: 'var(--text-secondary)', marginLeft: '4px' }}>
                Full Name
              </label>
              <input
                id="name"
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {/* Password */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label htmlFor="password" style={{ fontSize: '13.5px', fontWeight: 500, color: 'var(--text-secondary)', marginLeft: '4px' }}>
                  Password
                </label>
              ...
              {/* Confirm Password */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <label htmlFor="confirm" style={{ fontSize: '13.5px', fontWeight: 500, color: 'var(--text-secondary)', marginLeft: '4px' }}>
                  Confirm
                </label>
                <div style={{ position: 'relative' }}>
                  <input
            ...
            >
              {loading ? 'Creating Account...' : (
                <>Create Account <ArrowRight size={18} style={{ color: 'var(--accent)' }} /></>
              )}
            </button>
          </form>
          ...
          <div style={{ marginTop: '32px', paddingTop: '24px', borderTop: '1px solid var(--border)', textAlign: 'center' }}>
            <p style={{ fontSize: '14px', color: 'var(--text-secondary)', margin: 0 }}>
              ...
              <Link href="/auth/login" style={{ fontWeight: 600, color: 'var(--accent)', textDecoration: 'none' }}
